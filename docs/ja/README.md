...
- **[MakeMKV](https://www.makemkv.com/)** — DVD・Blu-rayディスクリッパー。プロプライエタリ。
- **[KDE Plasma](https://github.com/KDE/plasma-desktop)** — 多機能デスクトップ環境。**GPL-2.0**ライセンス。
- **[Google Chrome](https://www.google.com/chrome/)** — Googleのウェブブラウザ。プロプライエタリ。
...
- **[Vivaldi](https://vivaldi.com/)** — 多機能ウェブブラウザ。プロプライエタリ。
- **[Chromium](https://www.chromium.org/)** — Chromeの基盤となるオープンソースブラウザプロジェクト。**BSD-3-Clause**ライセンス。
- **[Microsoft Edge](https://www.microsoft.com/edge)** — Microsoftのウェブブラウザ。プロプライエタリ。
