...
- **[Rocky Linux](https://rockylinux.org/)** — 本プロジェクトを実現する基盤。素晴らしいコミュニティエンタープライズOS。
...
本リポジトリは[Fedora AI支援貢献ポリシー](https://docs.fedoraproject.org/en-US/council/policy/ai-contribution-policy/)に準拠しています。ClaudeのOpus 4.6モデルを使用してすべてを作成し、人間によるテストとレビューで検証・改善しています。
