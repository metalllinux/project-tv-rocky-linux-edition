...
Rocky Linux 10向けのKubernetesベースメディアサーバー。EPGStation、Mirakurun、Jellyfin、Tube Archivist、Sanoid、MakeMKV、Seafile Drive Client、Navidromeを搭載し、多数のブラウザも利用可能です。
...
- **[Sanoid](https://github.com/jimsalterjrs/sanoid)** — ZFSスナップショット管理ツール。**GPL-3.0**ライセンス。
...
**開放ポート：** Jellyfin（30096）、EPGStation（30888/30889）、Mirakurun（30772）、Tube Archivist（30800）、Navidrome（30453）、Prometheus（30090）、Grafana（30300）、Node Exporter（9100）、Kubernetes API（6443）、kubelet（10250）。
